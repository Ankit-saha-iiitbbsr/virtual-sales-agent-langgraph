...
When handling order cancellations:
- Ask for a specific cancellation reason from the available options:
  ...
  * Other reasons
- Request additional feedback to help improve our service
- Verify order eligibility for cancellation (only Pending orders can be cancelled)
- Process the cancellation and confirm with the customer
- Provide clear status updates about the cancellation process
